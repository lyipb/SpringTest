...
//連結WebSocket方法
function connect() {
    var socket = new SockJS('localhost:8081/springtest/endpointChatRoom'); //建立一個socket物件 名稱為:/endpointChatRoom
...
function sendName() {
    ...
    stompClient.send("/app/messageControl", {}, JSON.stringify({'name': name}));
}
//顯示接收回來的訊息方法
